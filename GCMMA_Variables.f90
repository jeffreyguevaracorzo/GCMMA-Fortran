module GCMMA_variables
    ...
    real, dimension(:,:), allocatable     :: raaeps
    ...
    real                                  :: f0app
    real, dimension(:,:), allocatable     :: fapp
    real                                  :: f0valnew
    real, dimension(:,:), allocatable     :: fvalnew
...
contains
    subroutine ObjectiveFunction(x,f0val,df0dx,fval,dfdx)
        ...
        !         (x(1)-3)^2+(x(2)-4)^2+(x(3)-3)^2-9]
        fval(1,1) = (x(1,1)-5.0)**2 + (x(2,1)-2.0)**2 + (x(3,1)-1.0)**2 - 9.0
        fval(2,1) = (x(1,1)-3.0)**2 + (x(2,1)-4.0)**2 + (x(3,1)-3.0)**2 - 9.0
